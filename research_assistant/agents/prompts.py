    ...
    return [
        Message(
            ...
            content=(
                ...
                "DRAFT research paper in Markdown, structured like an empirical "
                "academic article. Everything here is synthesized ONLY from web and "
                "academic literature — NO primary data was collected (no surveys, "
                "experiments or tests were run). The paper is a proposal-stage draft: "
                "the study design and findings are proposed, not carried out.\n"
                ...
                "paper's Abstract): what the draft investigates from the literature, "
                "the gap it identifies, and the study it proposes. Make clear it is a "
                "draft synthesizing existing work, not a completed study.\n"
                "- Then a '## Introduction' section: context and motivation for the "
                "goal question, key terms defined at first use, the research gap the "
                "literature leaves open, and the objectives/questions this paper "
                "targets. Do not repeat the abstract's wording.\n"
                "- Then one '## ' section per sub-question, in the order given, with "
                "a concise descriptive section title (not the question verbatim). "
                "These sections are the literature review / background — grounded in "
                "the findings with [n] citations.\n"
                "- Then a '## Proposed Methodology' section: the study design the "
                "author SHOULD run to answer the goal empirically — participants/"
                "sample, variables or materials, and procedure. Write it as a "
                "proposal in the future/conditional ('the study would recruit...', "
                "'participants should complete...'); invent NO results, data or "
                "numbers. Ground design choices in the literature with [n] where a "
                "finding supports them.\n"
                "- Then a '## Recommendations' section: concrete next steps to carry "
                "the paper forward — which surveys or questionnaires to administer "
                "and to whom, which hypotheses to test, and how to strengthen and "
                "extend the work. Make the recommendations specific and actionable, "
                "not generic advice.\n"
